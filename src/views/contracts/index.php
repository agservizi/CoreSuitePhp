<?php
// $contracts è fornito dal controller
?>
<!DOCTYPE html>
<html lang="it">
<head>
    ...
    <title>Contratti - CoreSuite</title>    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/admin-lte@3.2/dist/css/adminlte.min.css">
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">                    <li class="nav-item">
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Elenco Contratti</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="mb-3 d-flex flex-wrap align-items-center justify-content-between">
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        <?php if (isset($_SESSION['role']) && in_array($_SESSION['role'], ['admin','user'])): ?>
                            <a href="/contracts_create.php" class="btn btn-primary mb-2 mr-2"><i class="fas fa-plus"></i> Nuovo Contratto</a>
                        <?php endif; ?>
                        <a href="/export_contracts.php" class="btn btn-success mb-2"><i class="fas fa-file-csv"></i> Esporta CSV</a>
                    </div>
                    <form class="form-inline mb-2" id="searchForm" onsubmit="return false;">
                        <div class="input-group input-group-sm">
                            <input type="text" class="form-control" id="searchInput" placeholder="Cerca cliente, provider, tipo, stato...">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tutti i contratti</h3>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                                            <a href="/contracts_edit.php?id=<?= $c['id'] ?>" class="btn btn-warning btn-sm" title="Modifica"><i class="fas fa-edit"></i></a>
                                            <a href="/contracts_delete.php?id=<?= $c['id'] ?>" class="btn btn-danger btn-sm" title="Elimina" onclick="return confirm('Sei sicuro di voler eliminare questo contratto?');"><i class="fas fa-trash"></i></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
...
$(function() {
    ...
    // Esempio: ?success=Contratto+creato+con+successo
