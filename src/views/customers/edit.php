                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="document_type" id="document_type" class="form-control">
                                                    <option value="Carta d'identità" <?= $customer['document_type'] == "Carta d'identità" ? 'selected' : '' ?>>Carta d'identità</option>
                                                    <option value="Passaporto" <?= $customer['document_type'] == "Passaporto" ? 'selected' : '' ?>>Passaporto</option>
                                                    <option value="Patente" <?= $customer['document_type'] == "Patente" ? 'selected' : '' ?>>Patente</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="notes" id="notes" class="form-control" rows="4"><?= htmlspecialchars($customer['notes']) ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
