    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Dettaglio Cliente #<?= htmlspecialchars($customer['id']) ?></h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-8"><?= htmlspecialchars($customer['surname']) ?></dd>
                                    <dt class="col-sm-4">Codice Fiscale</dt>
                                    <dd class="col-sm-8"><?= htmlspecialchars($customer['fiscal_code']) ?></dd>
                                    <dt class="col-sm-4">Data di nascita</dt>
                                    <dd class="col-sm-8"><?= htmlspecialchars($customer['date_of_birth']) ?></dd>
                                    <dt class="col-sm-4">Luogo di nascita</dt>
                                    <dd class="col-sm-8"><?= htmlspecialchars($customer['place_of_birth']) ?></dd>
                                    <dt class="col-sm-4">Tipo documento</dt>
                                    <dd class="col-sm-8"><?= htmlspecialchars($customer['document_type']) ?></dd>
                                    <dt class="col-sm-4">Numero documento</dt>
                                    <dd class="col-sm-8"><?= htmlspecialchars($customer['document_number']) ?></dd>
                                    <dt class="col-sm-4">Scadenza documento</dt>
                                    <dd class="col-sm-8"><?= htmlspecialchars($customer['document_expiry']) ?></dd>
                                    ...
                                    <dd class="col-sm-8"><?= htmlspecialchars($customer['mobile']) ?></dd>
                                    <dt class="col-sm-4">Note</dt>
                                    <dd class="col-sm-8"><?= htmlspecialchars($customer['notes']) ?></dd>
                                </dl>
                            </div>
                            <div class="card-footer">
                                <a href="/customers.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Torna all'elenco</a>
                            </div>
                        </div>
                    </div>
                </div>
