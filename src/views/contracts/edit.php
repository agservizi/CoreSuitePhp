                            ...
                            <form method="post">
                                <div class="card-body">                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control" required>
                                            <option value="inserito" <?= $contract['status']==='inserito'?'selected':'' ?>>Inserito</option>
                                            <option value="in_lavorazione" <?= $contract['status']==='in_lavorazione'?'selected':'' ?>>In lavorazione</option>
                                            ...
                                            <option value="sospeso" <?= $contract['status']==='sospeso'?'selected':'' ?>>Sospeso</option>
                                            <option value="chiuso" <?= $contract['status']==='chiuso'?'selected':'' ?>>Chiuso</option>
                                            <option value="rifiutato" <?= $contract['status']==='rifiutato'?'selected':'' ?>>Rifiutato</option>
                                        </select>
                                    </div>
                                </div>
