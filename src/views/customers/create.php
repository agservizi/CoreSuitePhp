                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="surname" id="surname" class="form-control" value="<?= $_POST['surname'] ?? '' ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="fiscal_code">Codice Fiscale</label>
                                                <input type="text" name="fiscal_code" id="fiscal_code" class="form-control" value="<?= $_POST['fiscal_code'] ?? '' ?>" required maxlength="16">
                                            </div>
                                            <div class="form-group">
